...
from quicker_voice_runtime.protocol import dumps
from quicker_voice_runtime.recognizer.base import Recognizer
from quicker_voice_runtime.router import VoiceSessionRouter
...
def run_stdio(config: RuntimeConfig, recognizer: Recognizer) -> None:
    ...
    logger.info(
        "quicker-voice-runtime %s ready on stdio (model=%s)",
